...
class CmppShuTongYiDongShengBeiHuanBei extends Pzlife
{
    ...
    {
        return [
            'host'          => "101.132.177.0", //服务商ip
            'port'          => "7890", //短连接端口号   17890长连接端口号
            'Source_Addr'   => "100114", //企业id  企业代码
            'Shared_secret' => 'bgefpkcv', //网关登录密码
            'Service_Id'    => "100114", //业务代码
            'template_id'   => "", //模板id
            'Dest_Id'       => "10690123", //短信接入码 短信端口号 服务代码
            'Sequence_Id'   => 1,
            'SP_ID'         => "",
            'master_num'    => 500,
        ];
