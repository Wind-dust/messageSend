...
class ClientSocketJiuJiaXinTong extends Pzlife {
    ...
    public function content($content) {
        return [
            'host'          => "ac.jj-mob.com", //服务商ip
            'port'          => "9000", //短连接端口号   17890长连接端口号
            'Source_Addr'   => "yxlt01", //企业id  企业代码
            'Shared_secret' => '76brV6KJ', //网关登录密码
            'template_id'   => "", //模板id
            'Service_Id'    => "yxlt01", //业务代码
            'Dest_Id'       => "106907624967", //短信接入码 短信端口号
            'Sequence_Id'   => 1,
            'SP_ID'         => "",
            'master_num'    => 300,
        ];
                    ...
                    if ($send) { //正式使用从缓存中读取数据
                        ...
                        if (strlen($code) > $max_len) {
                            ...
                            for ($j = 0; $j < $num_messages; $j++) {
                                ...
                                $bodyData = $bodyData . pack('C', $j + 1); //Pk_number |Unsigned Integer |1 |相同 Msg_Id 的信息序号，从 1 开始
