...
class CmppBeiJingBaMiMarketing extends Pzlife
{
    ...
    {
        return [
            'host'          => "121.36.42.252", //服务商ip
            'port'          => "7890", //短连接端口号   17890长连接端口号
            'Source_Addr'   => "881288", //企业id  企业代码
            'Shared_secret' => 'FxdcFC', //网关登录密码
            'Service_Id'    => "881288", //业务代码
            'template_id'   => "", //模板id
    ...
    public function Send($content)
    {
        ...
        $redisMessageUnKownDeliver = 'index:meassage:code:unknow:deliver:' . $content; //行业通知MsgId
          ...
          $send = $redis->rPush($redisMessageCodeSend, json_encode([
            ...
            'content'     => '【方舟药业】秒杀销售KN959.9元/1包（2个装），外科用1.98元/个、一次性1.55元/个，更多点击https://web.fangzhouyy.com/d.htm或应用宝搜索"方舟药业"下载,使用手机号+密码(手机号后六位)登录',
