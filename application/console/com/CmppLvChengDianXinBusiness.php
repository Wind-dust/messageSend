...
class CmppLvChengDianXinBusiness extends Pzlife
{
    ...
    public function content($content)
    {
        return [
            ...
            'Source_Addr'   => "xjyhyx", //企业id  企业代码
            'Shared_secret' => 'xjyhyx001', //网关登录密码
            'Service_Id'    => "xjyhyx", //业务代码
            'template_id'   => "", //模板id
            'Dest_Id'       => "4257", //短信接入码 短信端口号 服务代码
            'Sequence_Id'   => 1,
            'SP_ID'         => "",
            'master_num'    => 200,
        ];
