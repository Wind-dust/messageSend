...
class CmppJuMengSanWangMarketing extends Pzlife
{
    ...
    public function content($content)
    {
        ...
        return [
            ...
            'port'          => "7890", //短连接端口号   17890长连接端口号
            'Source_Addr'   => "440779", //企业id  企业代码
            'Shared_secret' => '888KKK', //网关登录密码
            'Service_Id'    => "440779", //业务代码
            'template_id'   => "", //模板id
            'Dest_Id'       => "1069440779", //短信接入码 短信端口号 服务代码
            'Sequence_Id'   => 1,
            'SP_ID'         => "",
            'master_num'    => 300,
        ];
