...
class CmppCreateCodeTask extends Pzlife
{
    ...
    public function SendSflTask()
    {
        ...
        try {
            ...
            // $sendid = $mysql_connect->query("SELECT `id` FROM yx_sfl_send_task WHERE `create_time` >  '" . $tody_time . "' AND `template_id` = '100182540'  ");
    ...
    public function SendSflMulTask()
    {
        ...
        try {
            ...
            $sendid = $mysql_connect->query("SELECT `id` FROM yx_sfl_multimedia_message WHERE   `create_time` >  " . $tody_time  . "  AND  `sfl_relation_id` NOT IN ('100182480')  ");
