 ...
 */
    ...
    public function SendSflTask()
    {
        ...
        try {
            ...
            $mysql_connect->table('yx_sfl_send_task')->where([['template_id', '=', '100184672']])->update(['free_trial' => 2, 'yidong_channel_id' => 83, 'liantong_channel_id' => 84, 'dianxin_channel_id' => 84, 'update_time' => time()]);
