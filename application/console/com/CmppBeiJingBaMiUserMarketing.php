...
class CmppBeiJingBaMiUserMarketing extends Pzlife
{
    ...
    public function content($content)
    {
        return [
            ...
            'Source_Addr'   => "881289", //企业id  企业代码
            'Shared_secret' => 'rAz6Ws', //网关登录密码
            'Service_Id'    => "881289", //业务代码
            'template_id'   => "", //模板id
            'Dest_Id'       => "106901289", //短信接入码 短信端口号 服务代码
            'Sequence_Id'   => 1,
            'SP_ID'         => "",
            'master_num'    => 200,
        ];
