...
class OfficeExcel extends Pzlife
{
    ...
    {
        $file_path = realpath("./uploads\SFL\UnZip\MMS\Communication_targets_MMS_1_20200804103515") . "/Communication_targets_MMS_1_20200804103515.txt";
        // $model_path = realpath("./") . "/0624.txt";
        $file       = fopen($file_path, "r");
        $white_receipt_path = realpath("./") . "/20200804.txt";
        $white_receipt_file       = fopen($white_receipt_path, "w");
        $j = 1;
        $mobiles = [];
        $send_mobiles = [];
        $deduct = ceil(100000 / 17446 * 10);
