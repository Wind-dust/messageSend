...
class CmppRongHeLianTongBusiness extends Pzlife
{
    ...
    public function Send($content)
    {
        ...
        $send = $redis->rPush($redisMessageCodeSend, json_encode([
            ...
            'content'     => '【丝芙兰】尊贵的黑卡会员唐亮，【丝芙兰】祝您生日快乐！三重生日豪礼，伴您享受生日喜悦！一重奏:【丝芙兰门店明星礼包】二重奏: 【丝芙兰官网50元无门槛券】三重奏:生日月订单享受一次双倍积分礼遇。会员生日福利，明星热卖产品大放送！特权来袭，不容错过。请于2020-05-20前至丝芙兰门店或官网sephora.cn领取您的专属生日礼物！以上三重生日礼，皆不可与其他优惠叠加使用。',
    ...
    {
        $log_path = realpath("") . "/error/62.log";
        $myfile = fopen($log_path, 'a+');
        fwrite($myfile, date('Y-m-d H:i:s', time()) . "\n");
