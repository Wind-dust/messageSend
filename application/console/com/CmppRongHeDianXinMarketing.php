...
class CmppRongHeDianXinMarketing extends Pzlife
{
    ...
    public function content($content)
    {
        return [
            ...
            'Source_Addr'   => "269512", //企业id  企业代码
            'Shared_secret' => '613472', //网关登录密码
            'Service_Id'    => "269512", //业务代码
            'template_id'   => "", //模板id
            ...
            if (socket_write($socket, $headData . $bodyData, $Total_Length) == false) {
                ...
                if ($headData != false) {
                    ...
                    if ($head['Command_Id'] == 0x80000001) {
                        ...
                        //通道断口处理
                        if ($body['Status'] != 0) {
                            exit($error_msg."错误码：".$body['Status']);
                        }
