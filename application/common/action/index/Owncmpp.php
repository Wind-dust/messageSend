...
class Owncmpp {
    ...
    protected $host                = "";
    protected $port                = "";
    protected $Source_Addr         = "";
    protected $Shared_secret       = "";
    protected $Dest_Id             = "";
    protected $template_service_id = "";
    public $SP_ID         = "";

    /**
     * @param $host 主机
     * @param $port 端口
     * @param $Source_Addr 企业id  企业代码
     * @param $Shared_secret 网关登录密码
     * @param $Dest_Id 短信接入码
     *
     */
    public function Start($host, $port, $Source_Addr, $Shared_secret, $Dest_Id, $Service_Id) {
        $this->host                = $host;
        $this->port                = $port;
    ...
    public function cmppSubmit($tomsisdn = '', $contents = '') {
