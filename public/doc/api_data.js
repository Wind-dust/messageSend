define({ "api": [
  ...
  },
  {
        ...
        "返回": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>200:成功 / 3001:标题为空 / 3002:图片不存在 / 3003:内容为空 / 3009:添加失败 / 3010:图片没有上传过</p>"
          }
        ]
      }
    },
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/aboutus/addAboutus"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Aboutus.php",
    "groupTitle": "admin_Aboutus"
  },
  {
    "type": "post",
    "url": "/",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/aboutus/getAboutus"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Aboutus.php",
  ...
  },
  {
        ...
        "返回": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>200:成功 / 3001:id不存在或者不为数字 / 3002:用户不存在 / 3003:密码错误 / 3004:登录失败</p>"
          }
        ]
      }
    },
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/aboutus/updateAboutus"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Aboutus.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "添加应用案例",
    "description": "<p>addApplicationCase</p>",
    "group": "admin_ApplicationCase",
    "name": "addApplicationCase",
    "parameter": {
      "fields": {
        "入参": [
          {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/ApplicationCase/addApplicationCase"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/ApplicationCase.php",
    "groupTitle": "admin_ApplicationCase"
  },
  {
    "type": "post",
    "url": "/",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/ApplicationCase/getApplicationCase"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/ApplicationCase.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "修改应用案例",
    "description": "<p>updateApplicationCase</p>",
    "group": "admin_ApplicationCase",
    "name": "updateApplicationCase",
    "parameter": {
      "fields": {
        "入参": [
          {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/ApplicationCase/updateApplicationCase"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/ApplicationCase.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "添加下载中心",
    "description": "<p>addDownloadCenter</p>",
    "group": "admin_DownloadCenter",
    "name": "addDownloadCenter",
    "parameter": {
      "fields": {
        "入参": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>类型 1，服务类；2，行业平台，3验证码，4综合SMS平台</p>"
          },
          {
            "group": "入参",
            "type": "Number",
        ...
        "返回": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>200:成功 / 3001:标题为空 / 3002:图片不存在 / 3003:内容为空 / 3004:类型错误 / 3009:添加失败 / 3010:图片没有上传过</p>"
          }
        ]
      }
    },
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/downloadcenter/addDownloadCenter"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/DownloadCenter.php",
    "groupTitle": "admin_DownloadCenter"
  },
  {
    "type": "post",
    "url": "/",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/downloadcenter/getDownloadCenter"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/DownloadCenter.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "修改下载中心",
    "description": "<p>updateDownloadCenter</p>",
    "group": "admin_DownloadCenter",
    "name": "updateDownloadCenter",
    "parameter": {
      "fields": {
        "入参": [
          {
        ...
        "返回": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>200:成功 / 3001:id不存在或者不为数字 / 3002:类型错误 / 3003:密码错误 / 3004:登录失败</p>"
          }
        ]
      }
    },
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/downloadcenter/updateDownloadCenter"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/DownloadCenter.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/product/addProduct"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Product.php",
    "groupTitle": "admin_Product"
  },
  {
    "type": "post",
    "url": "/",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/product/getProduct"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Product.php",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/product/updateProduct"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Product.php",
        ...
        "返回": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>200:成功 / 3001:标题为空 / 3002:用户不存在 / 3003:密码错误 / 3004:登录失败</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/banner/updateBanner"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Banner.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "添加解决方案",
    "description": "<p>addSolution</p>",
    "group": "admin_solution",
    "name": "addSolution",
    "parameter": {
      "fields": {
        "入参": [
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/solution/addSolution"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Solution.php",
    "groupTitle": "admin_solution"
  },
  {
    "type": "post",
    "url": "/",
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/solution/getSolution"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Solution.php",
  ...
  },
  {
    ...
    "url": "/",
    "title": "修改解决方案",
    "description": "<p>updateSolution</p>",
    "group": "admin_solution",
    "name": "updateSolution",
    "parameter": {
      "fields": {
    ...
    "sampleRequest": [
      {
        "url": "http://127.0.0.1:1006/admin/solution/updateSolution"
      }
    ],
    "version": "0.0.0",
    "filename": "./application/admin/controller/Solution.php",
